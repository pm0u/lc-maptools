"use strict";var n=require("repl"),c=require("./package-BYhp9Pt0.cjs"),l=require("./index-z1p1GHes.cjs");require("url"),require("esbuild"),require("crypto"),require("fs"),require("path"),require("os"),require("./temporary-directory-CoGR4SrV.cjs"),console.log(`Welcome to tsx v${c.version} (Node.js ${process.version}).
