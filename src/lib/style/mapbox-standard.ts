...
const mapboxStandard = {
  ...
  terrain: {
    source: "mapbox-dem",
    exaggeration: ["interpolate", ["linear"], ["zoom"], 6, 0, 7, 1.5, 12, 2.2],
  },
  fog: {
  ...
  sprite: "mapbox://sprites/mapbox/standard/1gt0yzsvl7vcp400u2vgns4z9",
  ...
  layers: [
    ...
    },
    {
      ...
      type: "line",
      metadata: {
        "mapbox:group": "roads & transit network",
      },
      source: "composite",
      "source-layer": "road",
      minzoom: 16,
    ...
    },
    {
      ...
      type: "line",
      metadata: {
        "mapbox:group": "administrative boudaries",
      },
      source: "composite",
      "source-layer": "admin",
      minzoom: 7,
    ...
    },
    {
      ...
      type: "symbol",
      metadata: {
        "mapbox:group": "road & transit labels",
      },
      source: "composite",
      "source-layer": "road",
      minzoom: 10,
  ...
  created: "2023-10-26T16:35:57.777Z",
  modified: "2024-06-05T13:56:46.756Z",
  id: "standard",
  owner: "mapbox",
  visibility: "public",
  protected: true,
...
export const extendMapboxStandard = (style: {
  ...
  return {
    ...mapboxStandard,
    // @ts-expect-error
    sources: { ...mapboxStandard.sources, ...style.sources },
    // @ts-expect-error
    layers: [...mapboxStandard.layers, ...style.layers],
  };
};
